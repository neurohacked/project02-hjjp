...
=======
    ...
    // initial declared global variables to be modified later:
>>>>>>> aadcb2f56c5f6614cf7049d0015e91cdec8d3bb1
    var safetyScore = 0;
    // max pts 30
...
<<<<<<< HEAD
    ...
    // safeHouseNum = require('../js/safezoneCount');
    // console.log(safeHouseNum.getSafezoneCount());
    var safeHouseNum = 32;

    // weatherNum = require ('../js/weather.js')
    // console.log(weatherNum.getWeatherObj());
    // var currentTemp = weatherObj.currently.temperature;
    // var currentCondition = weatherObj.currently.precipProbability
    var currentCondition = 0.24;
    var currentTemp = 51;
